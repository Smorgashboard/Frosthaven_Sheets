...
struct CrashingTidePerkyView: View {
        ...
        VStack{
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with two Pierce 3 draw again cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) +1 Target card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Add two (+1) If you performed a Tide action this round, (+2), instead cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Ignore negative (-1) item effects, and, whenever you would gain Impair, prevent the condition").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you declare a long rest during card selection, gain Shield 1 for the round").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Gain advantage on all your attacks performed while occupying or targeting enemies occupying water hexes (REQUIRES ALL CHECKS TO BE UNLOCKED!)").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
