    ...
    var body: some View {
        ...
        VStack(alignment: .leading){
            HStack{
                ...
                .padding(.trailing)
                Text("Replace one (-2) card with a (+0) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Replace one (-1) card with one (+0 Consume Element: Generate Element) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Replace one (+0) card with one (+1 poison) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                ...
                .padding(.trailing)
                Text("Replace one (+0) card with one (+1 wound) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
            ...
            HStack{
                ...
                .padding(.trailing)
                Text("Add two (+1 push 3) cards").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Add one (2x brittle self) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Add one (+1 regenerate self draw again) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
        ...
        VStack(alignment: .leading){
            HStack{
                ...
                .padding(.trailing)
                Text("Whenever you short rest you may remove one negative condition from one ally within range 3").foregroundColor(.green)
            ...
            HStack{
                ...
                .padding(.trailing)
                Text("Once each Scenario, when you would give yourself a negative condition, prevent the condition").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Whenever you perform an action with a lost icon, you may discard one card to recover one card from your discard pile of equal or lower level (REQUIRES BOTH CHECKS TO UNLOCK!)").foregroundColor(.green)
