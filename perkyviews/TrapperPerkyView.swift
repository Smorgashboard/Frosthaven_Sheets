        ...
        VStack{
            ...
            VStack(alignment: .leading){
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Create one Heal +2 trap in an empty hex adjacent to the target, card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Create one 1 Damage trap in an empty hex adjacent to the target, card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace two (+0) cards with two (+0) add 2 Damage or Heal 2 to a trap within Range 2 of you, cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace two  (+1) cards with two (+2) Immobilize cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Add two Add Push 2 or Pull 2 draw again cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you long rest, you may create one 1 Damage trap in an adjacent empty hex").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you enter a hex with a trap, you may choose to not spring the trap").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("At the start of each scenario, you may create one 2 Damage trap in an adjacent empty hex").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
