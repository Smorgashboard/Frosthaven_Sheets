...
struct DeepwraithPerkyView: View {
        ...
        VStack{
            ...
            VStack(alignment: .leading){
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (+0) card with one (+0) Invisible Self card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Add two (+1) gain 1 Trophy token cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Ignore scenario effects and remove two (+0) cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you long rest, you may Loot one adjacent hex. If you gain any loot tokens, gain 1 Trophy").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("At the start of each scenario, gain 2 Trophies").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("While you have invisible, gain advantage on all your attacks (REQUIRES ALL CHECKS TO BE UNLOCKED!)").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
