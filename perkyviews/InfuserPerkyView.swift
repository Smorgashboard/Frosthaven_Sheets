        ...
        VStack{
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-2) card with one (-1) and one (-1) Air, Earth, Dark card").foregroundColor(accentColor)
                        .lineLimit(nil)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Air/Earth card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Air/Dark card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Earth/Dark card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (+0) card with (+2) card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (+0) card with three Move one waning element to strong cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Add two +1 Attack for each pair of active Infusions draw again cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Ignore Item (-1) effects. Whenever you become exhausted, keep all your active bonuses in play, with your summons acting on initiative 99 each round (REQUIRES BOTH CHECKS TO BE UNLOCKED!)").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you short rest, you may consume any element to Recover one spent Single Hand or Two Hand item").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Once each scenario, during ordering of initiative, after all ability cards have been revealed, create any element").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
