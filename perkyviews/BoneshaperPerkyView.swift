    ...
    var body: some View {
        ...
        VStack(alignment: .leading){
            HStack{
                ...
                .padding(.trailing)
                Text("Replace one (-1) card with one (+0 curse) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Replace one (-1) card with one (+0 poison)card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
        ...
        VStack(alignment: .leading){
            HStack{
                ...
                .padding(.trailing)
                Text("Replace one (+0) card with one (+1) Kill the attacking summon to instead add (+4)").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Add three (+1 health, target Boneshaper draw again) cards").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Add one (+2 leaf/dark) card").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Ignore scenario effects and add two (+1) cards").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Immediately before each of your rests, you may kill one of your summons to perform (bless) self").foregroundColor(.green)
            }
            .padding(.bottom)
            HStack{
                CheckBoxView(checked: Binding(
                ...
                .padding(.trailing)
                Text("Once each scenario, when any character ally would become exhausted by suffering (damage), you may suffer 2 damage to reduce their hit point value to 1 instead").foregroundColor(.green)
            ...
            HStack{
                ...
                .padding(.trailing)
                Text("At the start of each scenario, you may play a level 1 card from your hand to perform a summon action of the card   (REQUIRES BOTH CHECKS TO BE UNLOCKED!) ").foregroundColor(.green)
