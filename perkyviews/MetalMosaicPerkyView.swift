...
struct MetalMosaicPerkyView: View {
        ...
        VStack{
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Replace one (-1) card with one (+0) Increase or Decrease pressure card").foregroundColor(accentColor)
                        .lineLimit(nil)
                ...
                HStack{
                    ...
                    Text("Replace one (+0) card with one (+0) The target and all enemies adjacent to it suffer 1 Damage card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    Text("Replace two (+0) cards with one Pierce 3 draw again and one  Retaliate 2 draw again cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Add one (+1) Heal 2 self card").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Ignore item (-1) effects and add two (+1) cards").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you long rest, you may Increase or Decrease Pressure").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
            ...
            VStack(alignment: .leading){
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Whenever you would gain Poison, you may suffer 1 Damage to prevent the condition").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                ...
                HStack{
                    ...
                    .padding(.trailing)
                    Text("Once each scenario, when you would become exhausted, instead gain Stun and Invisible, lose all your cards, Recover four lost cards, and then discard the recovered cards (REQUIRES ALL CHECKS TO BE UNLOCKED!)").foregroundColor(accentColor)
                        .lineLimit(nil)
                        .fixedSize(horizontal: false, vertical: true)
                }
                .padding(.bottom)
